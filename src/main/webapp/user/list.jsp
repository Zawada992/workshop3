                ...
                <table class="table">
                    ...
                    <c:forEach items="${users}" var="user">
                        <tr>
                            ...
                            <td>${user.email}</td>
                            <td>
                                <a href='<c:url value="/user/delete?id=${user.userId}"/>'>Remove</a>
                                <a href='<c:url value="/user/edit?id=${user.userId}"/>'>Edit</a>
                                <a href='<c:url value="/user/show?id=${user.userId}"/>'>Show</a>
                            </td>
                        </tr>
                    </c:forEach>
                </table>
